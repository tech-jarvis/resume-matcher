...
export const PARSE_DEVSINC_RESUME_PROMPT = `You are a Devsinc HR specialist. Convert the resume into Devsinc's official client-facing resume template structure.
